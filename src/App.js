...
// 	}
	...
	class App extends Component{
		...
		toDoList = [
			{key:uuidv4(),title:"Home Work", completed:true},
			{key:uuidv4(),title:"Dinner", completed:true},
			{key:uuidv4(),title:"Fitness", completed:false}
		]

		addToDo = (title) => {
			newList = [title, ...toDoList]

		}

		render(){
			// console.log(this.toDoList.map((el) => el.key))
			return (
				<div className="container" >
					<div className="mt-5 mx-auto mw-xs">
						<AddToDo  />
